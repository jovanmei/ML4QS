...
# Add the 'Python3Code' directory to the system path
python3code_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'Python3Code'))
sys.path.append(python3code_path)
...
DATA_PATH = Path('../')
DATASET_FNAME = 'ch2_res.csv'
RESULT_FNAME = 'ch3_res_outliers.csv'
...
def main():
    ...
    outlier_columns = [ 'acc_phone_x', 'acc_phone_y', 'acc_phone_z', 'mag_phone_x', 'mag_phone_y', 'mag_phone_z',
    ...
    # We simply use this method to remove outliers based on a distance threshold.
        ...
        for col in outlier_columns:
            try:
                ...
                # remove rows where simple_dist_outlier is True
                dataset = dataset[dataset['simple_dist_outlier'] == False]
                
                # print size of dataset
                print(f"Size of dataset after removing outliers: {dataset.shape}")
